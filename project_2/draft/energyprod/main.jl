...
include("core.jl") # import all constants and functions
...
print("\nWould you like to perform the new sanity check? (y/n): ")
ans = lowercase(readline(stdin))
if ans == "y" || ans == "yes"
   new_sanitycheck(E) # perform sanity check with computed energies
end
