...
Z = Z_7Li + Z_7Be + Z_14N
μ = 1.0/(2*X + 3*(Y_4He + Y_3He)/4 + Z/2)


""" Solar parameters (core)"""

ρsol = 1.62e5 # density [kg/m^3]
Tsol = 1.57e7 # core temperature [K]
...
ρ_mean = 1.408e3 # average density of the sun [kg/m^3]

L0 = 3.846e26            # solar luminosity [w]
R0 = 6.96e8              # solar radius [m]
M0 = 1.989e30            # solar mass [kg]
ρ0 = 1.42e-7*ρ_mean      # density at solar surface
T0 = 5770                # stellar surface temperature [K]
Cp = 5/2*k_B/(μ*m_u)     # heat capacity at constant pressure
